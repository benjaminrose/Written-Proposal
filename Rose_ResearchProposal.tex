...
%(\cite{Scrimgeour12} says greater-equal 100h$^{-1}$Mpc in ΛCDM).  We already
...
clusters \citep{Kashlinsky10,Planckdf}, and with \sn{} data sets \citep[and others as seen in \Cref{t:review}]{Dai11,Rathaus13}.
...
% kaslinskly plot of measuremnts and what LCDM can allow.
...
illustrated  in \Cref{f:sn-needed}. This large sample size should be achievable
